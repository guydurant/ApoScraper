'''List of chemical identifiers that are commmon in crystal structures but do
not relate to a small molecule drug.

List originally taken from 
https://github.com/xchem/fragalysis-api/blob/master/fragalysis_api/xcimporter/non_ligs.json
with additional idnetifiers added.
'''
NON_LIGAND_HETATMS = [
    "F3F", "PJE", "DMS", "CL", "MG", "EDO", "PEG", "MLI", "NI",
    ...
    "DXE", "GU9", "IDO", "KO4", "NRU", "4MO", "HOH", "010", "PE5",
    "IMD", "MPD", "PCA", "21H", "LLP", "GOA", "PE4", "PG4", "1PE",
    "BOG", "TRS"]
